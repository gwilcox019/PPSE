...
./simulator.x -m 0 -M 14 -s 1 -e 100 -K 32 -N 8192 --src-all-zeros --mod-all-ones -D "rep-hard8" -f "hard8" --qf 5 --qs 7 &
./simulator.x -m 0 -M 14 -s 1 -e 100 -K 32 -N 8192 --src-all-zeros --mod-all-ones -D "rep-hard8-neon" -f "hard_neon" --qf 5 --qs 7 &
